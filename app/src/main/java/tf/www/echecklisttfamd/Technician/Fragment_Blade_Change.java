...
public class Fragment_Blade_Change extends Fragment {

    private String apilink;
    private TextView tvEquipment, tvDatetime, tvRequestor, tvDaily, tvRequestorName, tvTechName;
    private String scode,tvJR, tvTech;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        view = inflater.inflate(R.layout.fragement_blade_change, container, false);
    ...
    private void GetBlade(){
        String data = apilink +  "BladeJR=" + tvJR.replace("-","");
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if(response.isSuccessful()){
                    ...
                    showToastMsg("Job Request JR " + tvJR + " Blade Change Completed!");
    ...
    private void GetValue(){
        ...
        tvJR = prefs.getString("jr", "no data");
        tvTech = prefs.getString("techid","no data");
    }
}
